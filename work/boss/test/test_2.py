...
def get_url(query="", city="", industry="", position="", page=1):
    # https://www.zhipin.com/web/geek/job?query=python&city=101280600
    base_url = "https://www.zhipin.com/web/geek/job/?query={}&city={}&industry={}&position={}&page={}"
    urls = []
